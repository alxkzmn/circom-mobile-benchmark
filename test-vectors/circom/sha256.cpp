...
Circom_TemplateFunction _functionTable[99] = { 
H_0_run,
H_1_run,
H_2_run,
H_3_run,
...
Sha256_98_run };
Circom_TemplateFunction _functionTableParallel[99] = { 
NULL,
NULL,
NULL,
NULL,
...
uint get_total_signal_no() {return 612793;}

uint get_number_of_components() {return 5412;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 89698;}
...
uint aux_create = 1;
int aux_cmp_num = 1+ctx_index+1;
uint csoffset = mySignalStart+2848;
for (uint i = 0; i < 1; i++) {
...
uint aux_create = 2;
int aux_cmp_num = 2+ctx_index+1;
uint csoffset = mySignalStart+2880;
for (uint i = 0; i < 1; i++) {
...
uint aux_create = 3;
int aux_cmp_num = 3+ctx_index+1;
uint csoffset = mySignalStart+2912;
for (uint i = 0; i < 1; i++) {
...
uint aux_create = 4;
int aux_cmp_num = 4+ctx_index+1;
uint csoffset = mySignalStart+2944;
for (uint i = 0; i < 1; i++) {
...
uint aux_create = 7;
int aux_cmp_num = 7+ctx_index+1;
uint csoffset = mySignalStart+3040;
for (uint i = 0; i < 1; i++) {
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (0 + Fr_toInt(&lvar[2]))) + 256)];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 61
Fr_sub(&expaux[3],&circuitConstants[72],&lvar[2]); // line circom 61
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 8)]].signalStart + ((1 * Fr_toInt(&expaux[3])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Sha256compression_97_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (32 + Fr_toInt(&lvar[2]))) + 256)];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 62
Fr_sub(&expaux[3],&circuitConstants[134],&lvar[2]); // line circom 62
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 8)]].signalStart + ((1 * Fr_toInt(&expaux[3])) + 0)]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (64 + Fr_toInt(&lvar[2]))) + 256)];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 63
Fr_sub(&expaux[3],&circuitConstants[143],&lvar[2]); // line circom 63
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 8)]].signalStart + ((1 * Fr_toInt(&expaux[3])) + 0)]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (96 + Fr_toInt(&lvar[2]))) + 256)];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 64
Fr_sub(&expaux[3],&circuitConstants[144],&lvar[2]); // line circom 64
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 8)]].signalStart + ((1 * Fr_toInt(&expaux[3])) + 0)]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (128 + Fr_toInt(&lvar[2]))) + 256)];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 65
Fr_sub(&expaux[3],&circuitConstants[145],&lvar[2]); // line circom 65
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 8)]].signalStart + ((1 * Fr_toInt(&expaux[3])) + 0)]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (160 + Fr_toInt(&lvar[2]))) + 256)];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 66
Fr_sub(&expaux[3],&circuitConstants[146],&lvar[2]); // line circom 66
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 8)]].signalStart + ((1 * Fr_toInt(&expaux[3])) + 0)]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (192 + Fr_toInt(&lvar[2]))) + 256)];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 67
Fr_sub(&expaux[3],&circuitConstants[147],&lvar[2]); // line circom 67
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 8)]].signalStart + ((1 * Fr_toInt(&expaux[3])) + 0)]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (224 + Fr_toInt(&lvar[2]))) + 256)];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 68
Fr_sub(&expaux[3],&circuitConstants[148],&lvar[2]); // line circom 68
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 8)]].signalStart + ((1 * Fr_toInt(&expaux[3])) + 0)]);
}
// run sub component if needed
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * ((Fr_toInt(&lvar[1]) * 512) + Fr_toInt(&lvar[2]))) + 1280)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Sha256compression_97_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + ((1 * Fr_toInt(&lvar[2])) + 0)]);
}
{
PFrElement aux_dest = &lvar[2];
// load src
...
Sha256_98_create(1,0,ctx,"main",0);
Sha256_98_run(0,ctx);
}
